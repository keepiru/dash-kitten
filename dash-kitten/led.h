...
const uint8_t  PIN_LED_WARNING  =  10; ///< Warning LED pin number
const uint8_t  PIN_LED_ERROR    =  11; ///< Error LED pin number
const uint16_t LED_DURATION_MS  = 500; ///< How long the LED should be lit, milliseconds
